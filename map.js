const places = [
    {
        ...
        images: [
            'screenshots/tanglewood_drive_1.png',
            'screenshots/tanglewood_drive_2.png'
        ],
    ...
    },
    {
        name: 'Edgefield Road',
        images: [
            'screenshots/edgefield_road_1.png'
        ],
        hint: 'A two-story suburban house with many bedrooms.'
    },
    {
        name: 'Ridgeview Court',
        images: [
            'screenshots/ridgeview_court_1.png',
            'screenshots/ridgeview_court_2.png'
        ],
        hint: 'A two-story house with a long hallway, basement, and garage.'
    },
    {
        name: 'Grafton Farmhouse',
        images: [
            'screenshots/grafton_farmhouse_1.png'
        ],
        hint: 'A two-story farmhouse with large rooms and rustic furniture.'
    },
    {
        name: 'Willow Street House',
        images: [
            'screenshots/willow_street_house_1.png'
        ],
        hint: 'Another small house map, but with a more stretched layout and no closets.'
    },
    {
        name: 'Bleasdale Farmhouse',
        images: [
            'screenshots/bleasdale_farmhouse_1.png'
        ],
    ...
    },
    {
        name: 'Camp Woodwind',
        images: [
            'screenshots/camp_woodwind_1.png'
        ],
        hint: 'A tiny outdoor campsite map.'
    },
    {
        name: 'Maple Lodge Campsite',
        images: [
            'screenshots/maple_lodge_campsite_1.png'
        ],
        hint: 'Outdoor map with cabins, trails, a lake, and open ground.'
    },
    {
        name: 'Prison',
        images: [
            'screenshots/prison_1.png'
        ],
    ...
    },
    {
        ...
        images: [
            'screenshots/brownstone_high_school_1.png'
        ],
    ...
    },
    {
        name: 'Sunny Meadows',
        images: [
            'screenshots/sunny_meadows_1.png'
        ],
    ...
    },
    {
        ...
        images: [
            'screenshots/sunny_meadows_restricted_1.png'
        ],
        hint: 'A smaller variant of the asylum where some wings are blocked off.'
    },
    {
        name: 'Point Hope',
        images: [
            'screenshots/point_hope_1.png'
        ],
...
function resetGame() {
    ...
    targetPlace.currentImage = targetPlace.images[Math.floor(Math.random() * targetPlace.images.length)];
    lastGuessTime = 0;
    ...
    // Clear main canvas while loading
    baseCtx.clearRect(0, 0, baseCanvas.width, baseCanvas.height);
    drawMainWithReveal(false, revealSteps[0]);

    targetImageElement = new Image();
    targetImageElement.onload = () => {
        drawTargetArtwork();
        updateRevealState();
    };
    targetImageElement.onerror = () => {
        statusText.textContent = 'Failed to load screenshot: ' + targetPlace.currentImage;
        drawTargetArtwork();
        updateRevealState();
    };
    targetImageElement.src = targetPlace.currentImage;
...
function updateRevealState() {
    ...
    if (targetImageElement && targetImageElement.complete && targetImageElement.naturalWidth > 0) {
...
function drawTargetArtwork() {
    ...
    if (targetImageElement && targetImageElement.complete && targetImageElement.naturalWidth > 0) {
        baseCtx.drawImage(targetImageElement, 0, 0, baseCanvas.width, baseCanvas.height);
    } else {
        baseCtx.fillStyle = '#0b0b0b';
        baseCtx.fillRect(0, 0, baseCanvas.width, baseCanvas.height);
        baseCtx.fillStyle = '#ff4444';
        baseCtx.font = '20px "Roboto Mono", monospace';
        baseCtx.textAlign = 'center';
        baseCtx.fillText("Screenshot missing", baseCanvas.width / 2, baseCanvas.height / 2 - 10);
        baseCtx.font = '14px "Roboto Mono", monospace';
        baseCtx.fillStyle = '#888';
        baseCtx.fillText("Missing: " + (targetPlace ? targetPlace.currentImage : ''), baseCanvas.width / 2, baseCanvas.height / 2 + 20);
    }
...
function drawZoomReveal(unlocked) {
    ...
    if (unlocked <= 0) {
        ...
        zoomCtx.font = 'bold 20px "Roboto Mono", monospace';
